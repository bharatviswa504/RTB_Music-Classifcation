...
public class FeatureExtraction2 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            String[] classes = {"POP", "JAZZ","ROCK","FOLK","HIP HOP"};
    ...
    public static double[] makeData(File file, String str, FastVector attValsRel, int noOfAttributes) throws Exception {
        ...
        if(str==null)
        {
            ...
            val[1] = f1[0];
            double[] f2 = feature(samples, AudioFeature.Spectral_Rolloff_Point);
            val[2] = f2[1];
            double[] f3 = feature(samples, AudioFeature.Compactness);
            val[3] = f3[1];
            return val;
        }
        else {
    ...
    public static void classify(Instances train,File file) throws Exception {
        ...
        //Setting attributes for the test data
            ...
            Attribute attributeCompactness=new Attribute("Compactness");
            atts.addElement(attributeCompactness);
            for (int i = 0; i < classes.length; i++)
                attValsRel.addElement(classes[i]);
            atts.addElement(new Attribute("class", attValsRel));
        // Adding instances to the test dataset
            ...
            instance.setValue(attributeCompactness,val[2]);
            test.add(instance);
